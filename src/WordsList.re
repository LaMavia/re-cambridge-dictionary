  ...
  <ol className="words" id="words">
    {words->renderArray((i: int, w: word) =>
       <li className="words__item" key={i |> string_of_int}>
         ...
         <ol className="words__item__word__defs">
           {w.defs
            ->renderArray((j, d) =>
                <li
                  className="words__item__word__defs__item"
                  key={j |> string_of_int}>
                  <p className="words__item__word__defs__item__def">
                    {d.def |> React.string}
                  </p>
                  <p className="words__item__word__defs__item__eg">
